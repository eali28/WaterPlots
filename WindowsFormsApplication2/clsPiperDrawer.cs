...
namespace WindowsFormsApplication2
{
    public class clsPiperDrawer
    {
        ...
        public static void DrawPiperDiagram(Graphics g)
        {
            ...
            {
                int legendX = (int)(0.69f * frmMainForm.mainChartPlotting.Width);
                int legendY = (int)(0.13f*frmMainForm.mainChartPlotting.Height);
                int s = 0;
                for (int i = 0; i < frmImportSamples.WaterData.Count; i++)
                {
                    if (frmImportSamples.WaterData[i].Well_Name.Length + frmImportSamples.WaterData[i].ClientID.Length + frmImportSamples.WaterData[i].Depth.Length> s)
                    {
                        s = frmImportSamples.WaterData[i].Well_Name.Length + frmImportSamples.WaterData[i].ClientID.Length + frmImportSamples.WaterData[i].Depth.Length;
                    }
                }
                ...
                using (Font fontStyle = new Font("Times New Roman", legendtextSize, FontStyle.Bold))
                {
                    foreach (var data in frmImportSamples.WaterData)
                    {
                        ...
                        SizeF textSize = g.MeasureString(fullText, fontStyle);
                ...
                for (int i = 0; i < frmImportSamples.WaterData.Count; i++)
                {
                    ...
                    if (frmImportSamples.WaterData[i].shape != null && frmImportSamples.WaterData[i].shape!="Plus")
                    {
                        for (int j = 0; j < frmSymbolPicker.symbolNames.Count; j++)
                        {
                            ...
                            {
                                frmSymbolPicker.DrawSymbol(g, j, 2, ysample-5, 25, squareBrush);
                                break;
                            }
                    ...
                    else
                    {
                        ...
                        g.FillRectangle(squareBrush, 5, ysample+5, 0.02f * frmMainForm.mainChartPlotting.Height, 0.005f * frmMainForm.mainChartPlotting.Width);
                    }
        ...
        public static void ExportPiperDiagramToPowerpoint(PowerPoint.Slide slide, PowerPoint.Presentation presentation)
        {
            ...
            #region Variables
            // Get chart drawing area (ClientRectangle)
            float slideWidth = frmMainForm.mainChartPlotting.Width;
            float slideHeight = frmMainForm.mainChartPlotting.Height;

            // Set chartBounds equal to the slide bounds
            Rectangle chartBounds = new Rectangle(0, 0, (int)slideWidth, (int)slideHeight);

            int triangleHeight = availableHeight / 2 - 150;
            int triangleWidth = triangleHeight;
            ...
            Font titleFont = new Font("Times New Roman", 40, FontStyle.Italic);
            string title = "PIPER DIAGRAM";
            ...
            var text = slide.Shapes.AddTextbox(
                                        ...
                                        0, 15, 400, 100 // Adjust the position and size as needed
                                    );
            ...
            text.TextFrame.TextRange.Font.Size = 25; // Adjust the size as needed
            ...
            #region Define triangle and diamond bounds
            Rectangle cationTriangleBounds = new Rectangle(
                chartBounds.Left + frmMainForm.mainChartPlotting.Width / 2 - (int)(0.2 * frmMainForm.mainChartPlotting.Width) - (int)(diamondWidth / 1.7),
                chartBounds.Top + availableHeight - triangleHeight - 100,
                triangleWidth,
                triangleHeight);


            Rectangle diamondBounds = new Rectangle(
                chartBounds.Left + frmMainForm.mainChartPlotting.Width / 2 - (int)(0.2 * frmMainForm.mainChartPlotting.Width),
                chartBounds.Top + 160,
                diamondWidth,
                diamondHeight);
            Rectangle anionTriangleBounds = new Rectangle(
        ...
        public static void ExportTriangleToPowerpoint(PowerPoint.Slide slide, Rectangle bounds, string label, string[] data)
        {
            ...
            for (int i = 0; i < gridLines; i += 2)
            {
                ...
                leftside.TextFrame.TextRange.Font.Size = 15;
                ...
                rightside.TextFrame.TextRange.Font.Size = 15;
                ...
                bottomside.TextFrame.TextRange.Font.Size = 15;
            ...
            label1.TextFrame.TextRange.Font.Size = 15;
            ...
            label2.TextFrame.TextRange.Font.Size = 15;
            ...
            label3.TextFrame.TextRange.Font.Size = 15;
            ...
            if (label == "Cations")
            {
                ...
                text1.TextFrame.TextRange.Font.Size = 17;
                ...
                text2.TextFrame.TextRange.Font.Size = 17;
                ...
                text3.TextFrame.TextRange.Font.Size = 17;
                ...
                text4.TextFrame.TextRange.Font.Size = 17;
            ...
            Labeltext.TextFrame.TextRange.Font.Size = 25;
        ...
        public static void FindIntersectionPowerpoint(PowerPoint.Slide slide, PointF cationPoint, PointF anionPoint, PointF diamondCenter, Color brush, PointF top, Rectangle cationTriangleBounds, Rectangle anionTriangleBounds,string shape)
        {
            PointF[] cationvertices = new PointF[]
            {
                new PointF(cationTriangleBounds.Left, cationTriangleBounds.Bottom), // Bottom-left
            ...
            // Slope of the cation diagonal
            float m1 = (top.Y - cationPoint.Y) / ((top.X + (cationPoint.X - cationvertices[0].X)) - cationPoint.X);
            float b1 = cationPoint.Y - m1 * cationPoint.X;
            // Slope of the anion diagonal
            float m2 = (top.Y - anionPoint.Y) / ((top.X - (anionvertices[1].X - anionPoint.X)) - anionPoint.X);
            float b2 = anionPoint.Y - m2 * anionPoint.X;
            // Calculate intersection point
            float x = (b2 - b1) / (m1 - m2);
            float y = m2 * x + b2;
        ...
        public static void ExportDiamondToPowerpoint(PowerPoint.Slide slide, Rectangle bounds, Rectangle cationTriangleBounds, Rectangle anionTriangleBounds)
        {
            ...
            for (int i = 0; i <= gridLines; i += 2)
            {
                ...
                L1.TextFrame.TextRange.Font.Size = 15;
                ...
                L2.TextFrame.TextRange.Font.Size = 15;
            }
            ...
            PointF[] labelPositions = {
                new PointF(bounds.Left + bounds.Width / 2 - 30, bounds.Top + 60),
                new PointF(bounds.Left + bounds.Width / 2 - 35, bounds.Top + bounds.Height / 4+30),
                new PointF(bounds.Left + 20, bounds.Top + bounds.Height / 2-20),
                new PointF(bounds.Right - 110, bounds.Top + bounds.Height / 2-20),
                new PointF(bounds.Left + bounds.Width / 2 - 40, bounds.Bottom - bounds.Height / 4-70),
                new PointF(bounds.Left + bounds.Width / 2 - 50, bounds.Bottom - 130)
            };
            ...
            for (int i = 0; i < regionLabels.Length; i++)
            {
                PowerPoint.Shape label = slide.Shapes.AddTextbox(
                    Office.MsoTextOrientation.msoTextOrientationHorizontal,
                    labelPositions[i].X, labelPositions[i].Y, 150, 30
                );
            ...
            if (frmImportSamples.WaterData.Count > 0)
            {
                for (int i = 0; i < frmImportSamples.WaterData.Count; i++)
                {
                    ...
                    FindIntersectionPowerpoint(slide, cationVertices[i], anionVertices[i], diamondCenter, brush, vertices[0], cationTriangleBounds, anionTriangleBounds, frmImportSamples.WaterData[i].shape);
                }
            }
